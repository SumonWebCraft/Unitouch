...
// prettier-ignore
import { Center, Flex, Image, Input, InputGroup, InputLeftElement, Menu, MenuButton, MenuItem, MenuList, useColorMode, useColorModeValue } from "@chakra-ui/react";
  ...
  return (
    ...
    >
      <Link to={"/"}>
        ...
        <h1 className="title"> Unitouch </h1>
      </Link>
